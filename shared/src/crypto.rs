...
use crate::{errors::SamplyBrokerError, MsgTaskRequest, BeamId, EncryptedMsgTaskRequest, config};
...
pub(crate) struct CertificateCache{
    ...
    cn_to_serial: HashMap<BeamId, Serial>,
...
impl CertificateCache {
    ...
    pub async fn get_by_cname(cname: &BeamId) -> Option<X509> { // TODO: What if multiple certs are found?
    ...
    pub async fn get_all_cnames_and_certs() -> Vec<(BeamId,X509)> {
...
async fn get_cert_by_cname(cname: &BeamId) -> Option<X509>{
...
pub async fn get_cert_and_client_by_cname_as_pemstr(cname: &BeamId) -> Option<ClientPublicPortion> {
